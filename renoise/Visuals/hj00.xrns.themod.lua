...
return {
  ...
  mapping = 
  {
    ...
    a3 = { colorScheme=songOff, radioGroup="L1", osc = { triggerModule, "/TheMOD/Layer1Module[0]" } },
    b3 = { colorScheme=songOn, radioGroup="L1", osc = { triggerModule, "/TheMOD/Layer1Module[1]" } },
    c3 = { colorScheme=songOn, radioGroup="L1", osc = { triggerModule, "/TheMOD/Layer1Module[2]" } },
    d3 = { colorScheme=songOn, radioGroup="L1", osc = { triggerModule, "/TheMOD/Layer1Module[3]" } },
    e3 = { colorScheme=songOn, radioGroup="L1", osc = { triggerModule, "/TheMOD/Layer1Module[4]" } },
    f3 = { colorScheme=songOn, radioGroup="L1", osc = { triggerModule, "/TheMOD/Layer1Module[5]" } },
    g3 = { colorScheme=songOn, radioGroup="L1", osc = { triggerModule, "/TheMOD/Layer1Module[6]" } },


    a4 = { colorScheme=songOff, radioGroup="L2", osc = { triggerModule, "/TheMOD/Layer2Module[0]" } },
    b4 = { colorScheme=songOn, radioGroup="L2", osc = { triggerModule, "/TheMOD/Layer2Module[1]" } },
    c4 = { colorScheme=songOn, radioGroup="L2", osc = { triggerModule, "/TheMOD/Layer2Module[2]" } },
    d4 = { colorScheme=songOn, radioGroup="L2", osc = { triggerModule, "/TheMOD/Layer2Module[3]" } },
    e4 = { colorScheme=songOn, radioGroup="L2", osc = { triggerModule, "/TheMOD/Layer2Module[4]" } },
    f4 = { colorScheme=songOn, radioGroup="L2", osc = { triggerModule, "/TheMOD/Layer2Module[5]" } },
    g4 = { colorScheme=songOn, radioGroup="L2", osc = { triggerModule, "/TheMOD/Layer2Module[6]" } },

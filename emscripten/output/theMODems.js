...
function copyTempDouble(ptr) {
  ...
  function _canvasFillRect(x,y,w,h) { _tMctx.fillRect(x,y,w,h); }
  function ___canvasSetFillStyle(s) { _tMctx.fillStyle="#".concat(s.toString(16).slice(1)); }
...
function _cppRender($frameTime,$width,$height){
 var label=0;
 ___canvasSetFillStyle(33489024);
 _canvasFillRect(10,10,90,90);
 return;
}

...
// // see tweens here: http://sole.github.io/tween.js/examples/03_graphs.html
// Easing = {
// 	Linear: {
// 		None: function ( k ) {
// 			return k;
...
public:
	...
	{
		uint elapsedMS = timeMS - this->startTimeMS;
		double progress = (double)elapsedMS / (this->durationS * 1000);
